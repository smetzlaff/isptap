 ...
 ******************************************************************************/
#ifndef _ICACHE_DFA_HPP_
#define _ICACHE_DFA_HPP_
 ...
 */
class ICacheDataFlowAnalyzer : public ICacheDataFlowAnalyzer_IF {
	public:
		/*!
		 ...
		 */
		ICacheDataFlowAnalyzer(CFGMSGPair graph_pair, CFGMSGVPair entry_node, CFGMSGVPair exit_node);
		/*!
		 ...
		 */
		ICacheDataFlowAnalyzer(CFGMSGPair graph_pair, CFGMSGVPair entry_node, CFGMSGVPair exit_node, uint32_t mem_size);

		/*!
		 * \brief The default destructor.
		 */
		virtual ~ICacheDataFlowAnalyzer();
		/*!
		 ...
		 * For this analysis the abstract states are taken into account.
		...
		/**
		 * \brief Returns the number of cache memory states needed for the data flow analysis.
		 * For this analysis the abstract states are taken into account.
		 * \returns The number of cache memory states needed for the data flow analysis.
		 */
	...
	private:
		 ...
		 */
		CacheStateMaintainer *cache_state_maintainer;
		...
		property_map<MemoryStateGraph, mem_cache_hits_t>::type m_cacheHitsNProp;
		property_map<MemoryStateGraph, mem_cache_misses_t>::type m_cacheMissesNProp;
		property_map<MemoryStateGraph, mem_cache_ncs_t>::type m_cacheNCsNProp;
