 ...
 ******************************************************************************/
#ifndef _DISP_DFA_HPP_
#define _DISP_DFA_HPP_
 ...
 */
class DISPDataFlowAnalyzer : public DISPDataFlowAnalyzer_IF {
	public:
		/*!
		 * \brief Constructor for the disp data flow analyize object.
		 ...
		 */
		DISPDataFlowAnalyzer(CFGMSGPair graph_pair, CFGMSGVPair entry_node, CFGMSGVPair exit_node, FunctionCallGraphObject *fcgo);
		/*!
		 ...
		 */
		DISPDataFlowAnalyzer(CFGMSGPair graph_pair, CFGMSGVPair entry_node, CFGMSGVPair exit_node, FunctionCallGraphObject *fcgo, uint32_t mem_size);
		/*!
		 * \brief The default destructor.
		 */
		virtual ~DISPDataFlowAnalyzer();
		/*!
		 ...
		 * In this analysis the abstract states are taken into account.
	...
	private:
		 ...
		 */
		DISPStateMaintainer_IF *disp_state_maintainer;
